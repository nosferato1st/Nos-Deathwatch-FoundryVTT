...
export async function prepareCommonRoll(rollData) {
    const html = await renderTemplate("systems/nos-deathwatch/template/dialog/common-roll.html", rollData);
...
export async function prepareCombatRoll(rollData, actorRef) {
    const html = await renderTemplate("systems/nos-deathwatch/template/dialog/combat-roll.html", rollData);
    let dialog = new Dialog({
        title: rollData.name,
        content: html,
        buttons: {
...
export async function preparePsychicPowerRoll(rollData) {
    const html = await renderTemplate("systems/nos-deathwatch/template/dialog/psychic-power-roll.html", rollData);
    let dialog = new Dialog({
        title: rollData.name,
        content: html,
        buttons: {
